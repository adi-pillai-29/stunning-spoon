//Adi Pillai, arp3np@virginia.edu, 03/23/2021, "BinarySearchTree.h"
#ifndef BST_H
#define BST_H
...
private:
    ...
    string pathTo(BinaryNode*& n, const string& x);
    // find determines whether or not x exists in the tree.
    bool find(BinaryNode*& n, const string& x);
    // numNodes returns the total number of nodes in the tree.
    int numNodes(BinaryNode*& n);
};

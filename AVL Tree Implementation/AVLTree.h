//Adi Pillai, arp3np@virginia.edu, 03/26/2021, "AVLTree.h"
#ifndef AVL_H
#define AVL_H
...
private:
    ...
    AVLNode* insert(AVLNode*& node, const string& x);

    string pathTo(AVLNode*& n, const string& x);
    // find determines whether or not x exists in the tree.
    bool find(AVLNode*& n, const string& x);
    // numNodes returns the total number of nodes in the tree.
    int numNodes(AVLNode*& n);
};
